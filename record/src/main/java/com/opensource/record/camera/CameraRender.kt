package com.opensource.record.camera
...
import com.opensource.record.R
import com.opensource.record.fbo.FboRender
import com.opensource.record.fbo.ShaderUtil
import com.opensource.record.utils.DisplayUtil

//从摄像头渲染到fbo。使用扩展纹理。
class CameraRender(private val mContext: Context):CustomGlSurfaceView.CustomRender,SurfaceTexture.OnFrameAvailableListener {
