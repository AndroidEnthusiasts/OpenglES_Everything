...
Java_com_opensource_record_RecordActivity_startRecord(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_opensource_record_RecordActivity_stopRecord(JNIEnv *env, jobject thiz) {
    isFinish = true;
}