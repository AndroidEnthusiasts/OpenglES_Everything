...
import com.opensource.opengles.camera.core.CameraAPI14;
...
public class CameraQuarRender extends BaseCameraRenderer {
    ...
    private static final String VERTEX_SHADER_FILE = "shape/camera_vertex_shader.glsl";
    private static final String FRAGMENT_SHADER_FILE = "shape/camera_fragment_shader.glsl";
...
//        String vertexShaderCode = GLESUtils.readAssetShaderCode(AppCore.getInstance().getContext(), VERTEX_SHADER_FILE);
